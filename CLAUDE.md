...
- The hero art is the ascii cat `public/assets/kitokat-ascii-fine.avif` (rendered from `kitokat-raw.jpg`; the old dot-art hands stay in `public/assets/hero-hands.*`); partner logos in `public/assets/`.
