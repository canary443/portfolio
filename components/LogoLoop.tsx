'use client';
// reactbits LogoLoop (js+css variant), ported to ts. styles live in globals.css.
...
interface LogoItemBase { href?: string; title?: string; ariaLabel?: string }
interface LogoNodeItem extends LogoItemBase { node: ReactNode }
interface LogoImageItem extends LogoItemBase { src: string; srcSet?: string; sizes?: string; width?: number; height?: number; alt?: string }
...
export const LogoLoop = memo(function LogoLoop({
  ...
  pauseOnHover, hoverSpeed, fadeOut = false, fadeOutColor, scaleOnHover = false, renderItem,
  ...
  } as CSSProperties), [gap, logoHeight, fadeOutColor]);
  ...
  const containerStyle = useMemo(() => ({
    ...
    ...cssVariables,
    ...style
  } as CSSProperties), [width, cssVariables, style, isVertical]);
